...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //计算每类食品的top值，存入数组tops中
      _initTops() {
        const aLi = this.$refs.category.getElementsByClassName('food-list-hook');
        Array.prototype.slice.call(aLi).forEach((item, index) => {
